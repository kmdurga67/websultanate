...
const FrameComponent4 = ({
  ...
  return (
    <div
      className="w-[169px] relative rounded-lg bg-shade-2 box-border h-[75px] overflow-hidden shrink-0 text-left text-mini text-white font-bold border-[1px] border-solid border-pink"
      style={frameDiv2Style}
    >
      <div
        className="absolute top-[0px] left-[-31px] [filter:blur(93.4px)] rounded-[50%] bg-pink w-[75px] h-[75px]"
      ...
      <div className="absolute top-[7px] left-[8px] flex flex-row items-center justify-start gap-[8px]">
        ...
        <div className="flex flex-col items-start justify-start">
          <strong className="relative tracking-[-0.02em] font-bold">
            <span>{prop}</span>
            <span className="text-shade-7">{prop1}</span>
          </strong>
      ...
      <div
        className="absolute top-[10px] left-[0px] rounded-md bg-pink w-0.5 h-[55px] overflow-hidden"
